...
const HeroSection = () => {
  ...
  return (
    <>
      {/* Fixed Navigation */}
      <nav className="fixed top-0 left-0 right-0 bg-[#050609]/80 backdrop-blur-sm z-50 md:relative md:bg-transparent md:backdrop-blur-none">
          ...
          <div className="flex justify-between items-center h-16 md:h-auto py-2">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden md:flex space-x-10 items-center">
                <Link 
                  href="#categories"
                  className="text-xs font-extralight text-white/60 hover:text-white transition-colors tracking-[0.2em] uppercase py-2.5"
                >
                  Athletes
                </Link>
                <Link 
                ...
                <Link 
                  href="#cta"
                  className="text-xs font-extralight text-gray-900 bg-white hover:bg-gray-100 px-6 py-2.5 rounded-sm transition-all duration-300 tracking-[0.15em] uppercase transform hover:translate-y-[-2px] shadow-lg shadow-white/20"
                >
                  Become a Coach
                </Link>
              </div>
      ...
      <section className="relative min-h-[85vh] flex items-center mt-24 pt-16 md:mt-0 md:pt-0">
        ...
        >
          <div className="flex flex-col p-6">
            ...
            <div className="flex flex-col space-y-6">
              <Link 
                href="#categories"
                className="text-xs font-extralight text-white/60 hover:text-white transition-colors tracking-[0.2em] uppercase py-2"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Athletes
              </Link>
              ...
              <Link 
                href="#cta"
                className="text-xs font-extralight text-gray-900 bg-white hover:bg-gray-100 px-6 py-2.5 rounded-sm transition-all duration-300 tracking-[0.15em] uppercase text-center"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Become a Coach
              </Link>
