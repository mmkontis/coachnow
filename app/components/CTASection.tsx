...
Become an                <div className="absolute -bottom-1 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/30 to-transparent"></div>
              </span>
              {" "}
              <span className="text-white ml-1 text-glow-ai group-hover:animate-pulse transition-all duration-700 relative">
              AI Coach                <span className="absolute -inset-1 bg-white/5 blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-md"></span>
              </span>
            ...
            <div className="flex justify-center gap-5 pt-8">
              <button className="bg-white/[0.03] hover:bg-white/[0.06] text-white font-extralight py-4 px-8 rounded-sm transition-all duration-300 backdrop-blur-sm border border-white/5 hover:border-white/15 group relative overflow-hidden tracking-wider">
              ...
              <button className="border border-white/5 hover:border-white/15 text-white font-extralight py-4 px-8 rounded-sm transition-all duration-300 bg-white/0 backdrop-blur-sm relative overflow-hidden group tracking-wider">
